...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TestThemeComponent = resolveComponent("TestThemeComponent");
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_TestThemeComponent)
  ]);
}
const themeTest = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  themeTest as default
};
